...
export function MainLogo() {
    ...
    return (
        <Tooltip title="Home" position="bottom">
            <div className="main-logo-wraper clickable select clear size-40" onClick={() => navigate({ pathname: '/app/home' })}>
                <svg
                    className="logo-img"
                    viewBox="0 0 33 33"
                    fill="currentColor"
